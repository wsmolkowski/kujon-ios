...
//        (cell as! LectureTableViewCell).topic.backgroundColor  =  UIColor.kujonDarkerBlueColor()
    ...
    private func setTime()->NSAttributedString{
        ...
        atrText.addAttribute(NSForegroundColorAttributeName, value: UIColor.black, range: NSMakeRange(0, count(wrapper.startTime)))
        ...
        atrText.addAttribute(NSForegroundColorAttributeName, value: UIColor.black, range: NSMakeRange(lenght, count(wrapper.endTime)))
